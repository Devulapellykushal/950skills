...
const RULES = [
  ...
  { category: 'compliance', test: (s) => matches(s, ['soc2-compliance', 'gdpr-compliance', 'soc-2', 'gdpr-'], []) },
  { category: 'security', test: (s) => matches(s, ['security', 'pentest', 'vulnerability', 'attack', 'exploit', 'active-directory', 'anti-reversing', 'api-fuzzing', 'sql-injection', 'xss-', 'red-team', 'malware', 'forensics', 'sast', 'dast', 'broken-authentication', 'gdpr-data-handling', 'linux-privilege-escalation', 'metasploit-', 'mtls-configuration', 'injection-testing-comprehensive', 'owasp-asvs', 'owasp-api-security', 'prompt-injection'], []) },
